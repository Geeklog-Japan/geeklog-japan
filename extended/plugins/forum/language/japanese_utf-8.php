...
$LANG_GF00 = array(
    ...
    'useradminmenu' => '<i class="uk-icon-cog"></i> 掲示板の機能',
...
$LANG_GF01 = array(
    ...
    'NEWTOPIC' => '新規投稿',
    'POSTREPLY' => '<i class="uk-icon-reply"></i>',
    ...
    'TOP' => 'トップ',
    'PRINTABLE' => '<i class="uk-icon-print"></i>',
    'USERPREFS' => 'ユーザ設定',
...
$LANG_GF02 = array(
    ...
    'msg60' => '新着',
    'msg61' => '注目トピック',
    'msg62' => '<i class="uk-icon-play-circle"></i> メール通知開始',
    ...
    'msg137' => '<i class="uk-icon-pause"></i> メール通知解除',
    'msg138' => '<b>掲示板全体</b>',
    'msg142' => 'メール通知を開始しました。',
    'msg144' => 'トピックへ',
    'msg146' => 'メール通知を解除しました。',
    ...
    'PostReply' => '新しく書き込む',
    'PostTopic' => '<i class="uk-icon-comment-o"></i> 新規投稿',
    'EditTopic' => '<i class="uk-icon-edit"></i> 投稿編集',
...
$LANG_GF09 = array(
    ...
    'pm' => 'PM',
    'profile' => 'プロファイル',
    'quote' => '<i class="uk-icon-reply"></i> 引用',
    'website' => 'Webサイト',
    'newtopic' => '<i class="uk-icon-comment-o"></i> 新規投稿',
    'replytopic' => '<i class="uk-icon-reply"></i>'
);
