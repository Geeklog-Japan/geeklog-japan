...
$LANG_GF00 = array(
    ...
    'statsheading1' => '10 temas mテ。s visitados',
    'statsheading2' => '10 temas mテ。s comentados',
    'statsheading3' => 'No hay temas sobre los que informar',
    'useradminmenu' => 'Caracterテュsticas del foro',
...
$LANG_GF01 = array(
    ...
    'REPLIES' => 'Respuestas',
    'NAME' => 'Nombre:',
    'DESCRIPTION' => 'Descripciテウn: ',
    'TOPIC' => 'Tテウpico',
    'TOPICS' => 'Tテウpicos:',
    'TOPICSUBJECT' => 'Tema del tテウpico',
    'HOMEPAGE' => 'Inicio',
    'SUBJECT' => 'Tema',
    'HELLO' => 'Hola ',
    'MOVED' => 'Movido',
    'POSTS' => 'Mensajes',
    'LASTPOST' => 'テ嗟timo mensaje',
    'POSTEDON' => 'Enviado en',
    ...
    'ANON_PERM_MSG' => 'Ver mensajes anテウnimos',
    'POST_PERM_MSG1' => 'Puede enviar',
    'POST_PERM_MSG2' => 'Los usuarios anテウnimos pueden enviar',
    'GO' => 'Ir',
    'STATUS' => 'Estado:',
    'ONLINE' => 'conectado',
    ...
    'moderator' => 'Moderador',
    'admin' => 'Admin',
    'DATEADDED' => 'Fecha de adiciテウn',
    'PREVTOPIC' => 'Tテウpico anterior',
    'NEXTTOPIC' => 'Tテウpico siguiente',
    'RESYNC' => 'ReSync',
    'RESYNCCAT' => 'ReSync Foros de la Categorテュa',
    'EDITICON' => 'Editar',
    'QUOTEICON' => 'Cita',
    'ProfileLink' => 'Perfil',
    'WebsiteLink' => 'Website',
    ...
    'PRINTABLE' => 'Versiテウn para imprimir',
    'USERPREFS' => 'Preferencias de usuario',
    'SPEEDLIMIT' => '"Tu テコltimo comentario fuテゥ hace %s segundos.<br' . XHTML . '>Hace falta que pasen al menos %s segundos entre envテュos a los foros."',
    'ACCESSERROR' => 'ERROR DE ACCESO',
    'ACTIONS' => 'Acciones',
    'DELETEALL' => 'Borrar todos los registros seleccionados',
    'DELCONFIRM' => 'ツソSeguro que quieres Borrar los registros seleccionados?',
    'DELALLCONFIRM' => 'ツソSeguro que quieres borrar TODOS los registros seleccionados?',
    'STARTEDBY' => 'Iniciado por:',
    'WARNING' => 'Aviso',
    'MODERATED' => 'Moderadores: %s',
    'LASTREPLYBY' => 'テ嗟tima respuesta por:&nbsp;%s',
    'UID' => 'UID',
    'FORUMMENU' => 'Forum Menu',
    'INDEXPAGE' => 'テ肱dice del foro',
    'FEATURE' => 'Caracterテュstica',
    'SETTING' => 'Preferencia',
    'MARKALLREAD' => 'Marcar todos como leテュdos',
    'MSG_NO_CAT' => 'No Categories or Forums Defined',
    'FORUMPOSTS' => 'Forum Posts',
    'CODE' => 'Cテウdigo',
    'FONTCOLOR' => 'Color de letra',
    'FONTSIZE' => 'Tamaテアo de letra',
    'CLOSETAGS' => 'Cerrar Marcas',
    'CODETIP' => 'Truco: Puedes aplicar rテ。pidamente Estilos al texto seleccionado',
    'TINY' => 'Diminuto',
    'SMALL' => 'Pequeテアo',
    'NORMAL' => 'Normal',
    'LARGE' => 'Grande',
    ...
    'c_help' => 'Cテウdigo: [code]cテウdigo[/code]',
    ...
    's_help' => 'Color de texto: [color=red]texto[/color]  Truco: tambiテゥn puedes usar color=#FF0000',
    'f_help' => 'Tamaテアo: [size=x-small]texto pequeテアo[/size]',
    'h_help' => 'Pulsa para obtener ayuda detallada'
);

$LANG_GF02 = array(
    'msg01' => 'Lo sentimos, debe inscribirse parea usar estos foros',
    'msg02' => 'ツ。No deberテュas estar aquテュ!<br' . XHTML . '>Acceso restringido a este foro solamente',
    'msg03' => 'Please wait while you are redirected',
    'msg05' => '<center><em>Lo sentimos, aテコn no se ha creado ningテコn tテウpico.</em></center>',
    ...
    'msg18' => 'ツ。Error! No has rellenado todos los campos requeridos o eran demasiado cortos.',
    'msg19' => 'Tu mensaje ha sido enviado.',
    'msg22' => '- Notificaciテウn de envテュo al foro',
    'msg23a' => "Hay una respuesta a la discusiテウn '%s' por %s.\n\nEste tテウpico lo iniciテウ %s en el foro %s. ",
    'msg23b' => "Hay un tテウpico nuevo '%s' enviado por %s en el foro %s en el servidor %s. Puedes verlo en:\n%s/forum/viewtopic.php?showtopic=%s\n",
    'msg23c' => "Puedes verlo en:\n%s/forum/viewtopic.php?showtopic=%s&lastpost=true\n",
    'msg25' => "\nツ。Que tengas un gran dテュa! \n",
    'msg26' => "\nEstas recibiendo este mensaje por que has elegido ser notificado cuando hubiera una respuesta a este tテウpico. ",
    'msg27' => "Para dejar de recibir notificaciones en este tテウpico ve a <%s> para eliminarlas.\n",
    'msg33' => 'Autor: ',
    'msg36' => 'テ］imo:',
    'msg38' => 'Avisarme de las respuestas ',
    'msg40' => '<br' . XHTML . '>Lo siento, ya has pedido que te avisemos de las respuestas a este tテウpico.<br' . XHTML . '><br' . XHTML . '>',
    'msg44' => '<p style="margin:0px; padding:5px;">No tienes ninguna notificaciテウn.</p>',
    'msg49' => '(Leテュdo %s veces) ',
    'msg55' => 'Mensaje Borrado.',
    'msg56' => 'IP Prohibida.',
    'msg59' => 'Tテウpico normal',
    'msg60' => 'Mensaje Nuevo',
    'msg61' => 'Tテウpico Pegado',
    'msg62' => 'Avisarme de las respuestas',
    'msg64' => 'ツソSeguro que quieres borrar el tテウpico %s titulado: %s ?',
    'msg65' => '<br' . XHTML . '>Este es un tテウpico principal, asテュ que todas las respuestas enviadas se borrarテ。n tambiテゥn.',
    'msg68' => 'Nota: TEN CUIDADO AL EXPULSAR, solo los administradores tienen derecho a readmitir a alguien.',
    'msg69' => 'ツソRealmente quieres expulsar la direcciテウn IP: %s?',
    'msg71' => 'No has elegido ninguna acciテウn, elige un mensaje y entonces una acciテウn de moderaciテウn..<br' . XHTML . '>Nota: Debes ser un moderador para realizar estas acciones.',
    'msg72' => 'Aviso, no tienes derecho a realizare esta acciテウn de moderaciテウn.',
    'msg74' => 'テ嗟timos %s Mensajes al Foro',
    'msg75' => ' %s Tテウpicos mテ。s visitados',
    'msg76' => '%s Tテウpics con mテ。s mensajes',
    'msg77' => '<br' . XHTML . '><p style="padding-left:10px;">ツ。No deberテュas estar aquテュ!<br' . XHTML . '>Acceso restringido solo a este foro.</p>',
    'msg83' => '<br' . XHTML . '><br' . XHTML . '>Necesitas identificarte para usar esta caracterテュstica del foro.</p>',
    'msg84' => 'Marcar todos los tテウpicos como leテュdos',
    'msg85' => 'Pテ。gina:',
    'msg86' => '&nbsp;テ嗟timos %s mensajes&nbsp;',
    'msg87' => '<br' . XHTML . '>Aviso: Este tテウpico ha sido bloqueado por el moderador.<br' . XHTML . '>No se permiten mテ。s mensajes',
    ...
    'msg108' => 'Foro Activo',
    'msg109' => 'Tテウpico bloqueado',
    'msg110' => 'Yendo a la pテ。gina de correcciテウn de mensajes..',
    'msg111' => 'Mensajes nuevos desde tu テコltima visita',
    'msg112' => 'Ver todos los mensajes nuevos',
    'msg113' => 'Ver mensajes nuevos',
    'msg114' => 'Tテウpico bloqueado',
    'msg115' => 'Tテウpico pegado con nuevo mensaje',
    'msg116' => 'Tテウpico bloqueado con nuevo mensaje',
    'msg117' => 'Buscar en todo',
    'msg118' => 'Buscar en este foro',
    'msg119' => 'Resultados de la bテコsqueda en el Foro:',
    'msg120' => 'Mensajes mテ。s populares por',
    'msg121' => 'Todas las horas son %s. Hora actual %s.',
    'msg122' => 'Lテュmite Popular:',
    'msg123' => 'Nテコmero de mensajes antes de llamar popular a un tテウpico',
    'msg126' => 'Lテュneas de bテコsqueda:',
    'msg127' => 'Nテコmero de lテュneas a mostrar en los resultados de la bテコsqueda',
    'msg128' => 'Miembros por pテ。gina:',
    'msg129' => 'Pantalla de listado para los miembros',
    'msg130' => 'Ver mensajes anテウnimos:',
    'msg131' => 'Elegir No eliminarテ。 los mensajes anテウnimos',
    'msg132' => 'Avisar siempre:',
    'msg133' => 'Elegir Si permitirテ。 la notificaciテウn automテ。tica para cualquier tテウpico quie crテゥes o respondas.',
    'msg134' => 'Subscripciテウn Aテアadida',
    'msg135' => 'A partir de ahora se te avisarテ。 de todos los mensajes a este foro.',
    'msg136' => 'Debes elegir un foro al que suscribirte.',
    'msg137' => 'Permitida la notificaciテウn para tテウpicos',
    'msg138' => '<b>Subscrito a todo el foro</b>',
    'msg142' => 'Notificaciテウn guardada.',
    'msg144' => 'Volver al tテウpico',
    'msg146' => 'Notificaciテウn Borrada',
    'msg147' => 'Foro [versiテウn imprimible del tテウpico',
    'msg148' => 'Pulsa <a href="javascript:history.back()">AQUテ/a> para volver',
