...
$LANG_GF00 = array(
    ...
    'useradminmenu' => 'Funzionalitdel Forum',
...
$LANG_GF01 = array(
    ...
    'h_help' => 'Clicca qui per vedere una guida pi德dettagliata'
);

$LANG_GF02 = array(
    'msg01' => 'Spiacente, vedi registrarti per utilizzare questo forum',
    'msg02' => 'Non dovresti essere qui!<br' . XHTML . '>L\'accesso a questo forum ristretto',
    'msg03' => 'Attendi mentre vieni trasferito',
    'msg05' => '<center><em>Spiacente, non ancora stato creato alcun argomento.</center></em>',
    'msg07' => 'Utenti Online:',
    'msg14' => 'Spiacente, Ti stato impedito di creare nuovi inserimenti.<br' . XHTML . '>',
    ...
    'msg19' => 'Il tuo messaggio stato inviato.',
    'msg22' => '- Notifica Nuovo Messaggio sul Forum',
    'msg23a' => "\nUna risposta stata aggiunta all'argomento '%s' da %s\n\nQuesto argomento stato aperto da %s nel forum %s.\n",
    'msg23b' => "Il nuovo argomento '%s' stato aggiunto da %s nel forum %s sul sito web %s.\nPuoi vederlo su: %s/forum/viewtopic.php?showtopic=%s\n",
    'msg23c' => "\nPuoi leggerlo su: %s/forum/viewtopic.php?showtopic=%s&lastpost=true\n",
    'msg25' => "\nBuona giornata! \n",
    'msg26' => "\nHai ricevuto questa e-mail perchhai scelto di ricevere una notifica\nper ogni risposta aggiunta.",
    'msg27' => 'Per non ricevere pinotifiche su questo argomento vai <a href="%s">qui</a> per rimuoverti.',
    'msg33' => 'Autore: ',
    'msg36' => 'Umore:',
    'msg38' => 'Inviami una Notifica per ogni risposta ',
    'msg40' => '<br' . XHTML . '>Spiacente, ma hai gichiesto di ricevere notifiche per risposte a questo argomento.<br/><br/>',
    ...
    'msg65' => '<br' . XHTML . '>C\'un argomento superiore, per cui saranno eliminate anche tutte le risposte a questo.',
    ...
    'msg71' => 'Nessuna funzione selezionata, scegli un messaggio e poi una funzione di moderazione.<br' . XHTML . '>Nota: Devi essere un moderatore per utilizzare queste funzionalit甌',
    'msg72' => 'Se questo messaggio online non hai i diritti per eseguire questa operazione di moderazione.',
    'msg74' => 'Ultimi %s Messaggi sul Forum',
    'msg75' => 'Top %s Argomenti Per Visite',
    'msg76' => 'Top %s Argomenti Per Numero Messaggi',
    'msg77' => '<br' . XHTML . '><p style="padding-left:10px;">Non dovresti essere qui!<br' . XHTML . '>Questo forum ad accesso riservato.</p>',
    'msg83' => '<br' . XHTML . '><br' . XHTML . '>Devi essere loggato per utilizzare questa funzionalitdi questo forum.</p>',
    'msg84' => 'Segnala tutti gli argomenti come giletti',
    'msg85' => 'Pagina:',
    'msg86' => '&nbsp;Ultimi %s messaggi&nbsp;',
    'msg87' => '<br' . XHTML . '>Attenzione: Questo argomento stato bloccato dal moderatore.<br' . XHTML . '>Non possibile inviare altri messaggi',
    'msg88' => 'Utenti con Attivitsul Forum',
    ...
    'msg120' => 'Messaggi pi德visti per',
    'msg121' => 'Tutti gli orari sono %s. L\'ora attuale %s.',
    ...
    'msg131' => 'L\'impostazione No filtreri messaggi anonimi',
    ...
    'msg172' => 'L\'argomento non esiste. Probabilmente stato eliminato',
    ...
    'msg183' => 'In nuovo argomento stato creato nel forum: %s',
    ...
    'msg189' => 'Errore: Non puoi pimodificare questo messaggio',
    'msg190' => 'Modifica Nascosta',
    'msg191' => 'Modifica non permessa. Il tempo di modifica consentito scaduto o hai bisogno di permessi da moderatore',
    ...
    'msg300' => 'Il blocco per messaggi anonimi attivo nelle tue preferenze',
...
$LANG_GF03 = array(
    ...
    'movetopicmsg' => '<br' . XHTML . '>ノ possibile spostare l\'argomento <b>%s</b> nei seguenti forum:',
...
$LANG_GF93 = array(
    ...
    'moderatorwarning' => '<b>Attenzione: Non stato definito alcun Forum</b><br' . XHTML . '><br' . XHTML . '>Imposta le Categorie dei Forum e Aggiungi almeni 1 forum<br' . XHTML . '>prima di provare ad aggiungere Moderatori',
    ...
    'hiddendscp' => 'Forum non verrmostrato nell\'elenco dei forum',
...
$LANG_GF95 = array(
    ...
    'notyet' => 'Questa funzionalitnon stata ancora implementata',
...
$LANG_GF96 = array(
    ...
    'gfipman' => 'Gestione IP',
    'ban' => 'Blocca',
    'noips' => 'Nessun IP stato ancora bloccato!',
    'unban' => 'Sblocca',
...
$PLG_forum_MESSAGE2 = 'Aggiornamento dell\'Estensione Forum: Non possibile aggiornare questa versione automaticamente. Vedi la documentazione delle estensioni.';
$PLG_forum_MESSAGE5 = 'L\'aggiornamento dell\'estensione Forum fallito - vedi file error.log';
...
$LANG_confignames['forum'] = array(
    ...
    'post_speedlimit' => 'Limite di Velocitper l\'Inviodei Messaggi (sec)',
    'allowed_editwindow' => 'Tempo(sec) per Consentire la Modifica dei Messaggi',
    'allow_html' => 'Consentire ModalitHTML?',
    'post_htmlmode' => 'Impostare ModalitHTML come Predefinita?',
    'convert_break' => 'Convertire i Ritorni a Capo al Tag HTML &lt;BR&gt;?',
    'use_censor' => 'Utilizzare la Funzionalitdi Cenura di Geeklog?',
    'use_glfilter' => 'Utilizzare la Funzionalitdi Filtraggio di Geeklog?',
